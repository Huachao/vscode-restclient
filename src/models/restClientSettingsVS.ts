...
export class RestClientSettingsVS implements RestClientSettings {
    ...
    private static _instance: RestClientSettingsVS;

    public static get Instance(): RestClientSettings {
        if (!RestClientSettingsVS._instance) {
            RestClientSettingsVS._instance = new RestClientSettingsVS();
        }

        return RestClientSettingsVS._instance;
    }
