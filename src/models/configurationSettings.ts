...
export class RestClientSettings implements IRestClientSettings {
    ...
    public dotenvFilename: string;
    public requestVariableScope: string;
    ...
    private initializeSettings() {
        ...
        this.dotenvFilename = restClientSettings.get<string>('dotenvFilename', '.env');
        this.requestVariableScope = restClientSettings.get<string>('requestVariableScope', 'file');
