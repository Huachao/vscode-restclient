...
export async function activate(context: ExtensionContext) {
    ...
    context.subscriptions.push(commands.registerCommand('rest-client.request-run-script', ((document: TextDocument, range: Range) => requestController.runScript(range))));
