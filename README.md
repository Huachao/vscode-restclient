...
* `rest-client.requestNameAsResponseTabTitle`: Show request name as the response tab title. If no request name is specified defaults to "Response". (Default is __false__)
